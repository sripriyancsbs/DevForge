...
class ProvisioningJob(Base):
    ...
    current_step = Column(String(50), nullable=False, default="VALIDATE_CONFIGURATION")  # VALIDATE_CONFIGURATION, PREPARE_WORKSPACE, GENERATE_PROJECT, GENERATE_MANIFEST, VALIDATE_PROJECT, COMPLETED
